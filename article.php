                    ...
                    <div class="p-6">                        <div class="flex items-center text-sm text-gray-600 dark:text-gray-400 mb-4">                            <span class="mr-4">
                        ...
                        <div class="flex flex-wrap gap-3 mb-6">
                            ...
                            foreach ($tags as $tag):
                                ...
                                if (!empty($tag)):
                            ?>
                                <a href="/etiket/<?php echo urlencode($tag); ?>" class="inline-block bg-blue-100 hover:bg-blue-200 dark:bg-blue-900 dark:hover:bg-blue-800 text-blue-700 dark:text-blue-300 rounded-full px-4 py-2 text-base font-medium transition-colors duration-200">
                                    <i class="fas fa-tag text-sm mr-2"></i> <?php echo htmlspecialchars($tag); ?>
                                </a>
                            <?php 
                                endif;
                            endforeach; 
